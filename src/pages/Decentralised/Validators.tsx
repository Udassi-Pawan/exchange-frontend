  ...
  return (
    <Box mt={10}>
      <Stack alignItems={"center"}>
        ...
        {attestor == false && Number(validationTokens) == 0 && (
        ...
        {attestor == false && Number(validationTokens) > 0 && (
          <Stack alignItems={"center"} spacing={3}>
            ...
            <Typography textAlign={"center"} variant="h6">
              ...
              {"  "}
              in order to deposit 1000wei and become a validator again.
            </Typography>
            <Typography textAlign={"center"} variant="h6">
              You can still withdraw your existing balance.
            </Typography>
            <Typography textAlign={"center"} variant="h6">
              Your Validation Tokens Balance on {nameFromId.get(chainId)} chain
